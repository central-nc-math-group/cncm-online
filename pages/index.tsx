...
export default function Home() {
  ...
  return (
    <>
        <Navbar num={0}/>
      <div className="flex h-80 w-full bg-green-600 mx-auto md-5 items-center justify-center text-5xl sm:text-6xl text-white">
      ...
      <div className="flexbox w-4/5 mx-auto mt-5">
        <div className="flex w-full">
          ...
          <h1 className="font-medium leading-tight text-3xl sm:text-5xl mt-0 mb-2 text-green-600 m-1/4">UNC Contest Rerun</h1>
        </div>
