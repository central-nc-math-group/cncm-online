...
const Signup: React.FC<SignupProps> = () => {
  ...
  return (
    <div className={"mt-10 grid content-center justify-center"}>
      <h1 className={"mb-6 text-3xl grid content-center justify-center w-full max-w-sm text-blue-500"}>Sign up!</h1>
      <form
      ...
      >
        <div className={"md:flex md:items-center mb-6"}>
					<div className={"md:w-1/3"}>
						<label 
							className={"block text-gray-500 font-bold md:text-left md-1 md:mb-0 pr-4"} for="email">
						Email
						</label>
					</div>
        ...
        <div className={"md:flex md:items-center mb-6"}>
					<div className={"md:w-1/3"}>
					<label 
						className={"block text-gray-500 font-bold md:text-left md-1 md:mb-0 pr-4"} for="password">
          Password
					</label>
					</div>
